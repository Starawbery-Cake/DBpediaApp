...
result = quereis.do_inquiry(quereis.create_query_for_get_object_from_set_of_entity_and_property(objectURI="http://ja.dbpedia.org/resource/東京都", propertyURI="http://dbpedia.org/ontology/birthDate"))
print(result)
